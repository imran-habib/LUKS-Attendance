            ...
            container.Page(page =>
            {
                ...
                page.Content().PaddingTop(10).Table(table =>
                {
                    table.ColumnsDefinition(cols =>
                    {
                        ...
                        cols.ConstantColumn(45);  // Daily Rate
                        cols.ConstantColumn(40);  // Hourly Rate
                    ...
                    table.Header(h =>
                    {
                        ...
                        h.Cell().Border(0.5f).Background("#1a237e").Padding(3).Text("Rate").Bold().FontSize(8).FontColor(Colors.White);
                        h.Cell().Border(0.5f).Background("#1a237e").Padding(3).Text("Hr Rate").Bold().FontSize(7).FontColor(Colors.White);
